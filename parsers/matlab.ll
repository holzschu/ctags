...
@.str = private unnamed_addr constant [7 x i8] c"MatLab\00", align 1
@extensions = internal constant [2 x i8*] [i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0), i8* null], align 8
@matlabTagRegexTable = internal global [4 x %struct.tagRegexTable] [%struct.tagRegexTable { i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.4, i32 0, i32 0), i8* null, i8* null, i8 0 }, %struct.tagRegexTable { i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.4, i32 0, i32 0), i8* null, i8* null, i8 0 }, %struct.tagRegexTable { i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.4, i32 0, i32 0), i8* null, i8* null, i8 0 }, %struct.tagRegexTable { i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.8, i32 0, i32 0), i8* null, i8* null, i8 0 }], align 8
@selectors = internal global [2 x i8* (%struct._MIO*, i32*, i32)*] [i8* (%struct._MIO*, i32*, i32)* @selectByObjectiveCAndMatLabKeywords, i8* (%struct._MIO*, i32*, i32)* null], align 8
@.str.1 = private unnamed_addr constant [2 x i8] c"m\00", align 1
@.str.2 = private unnamed_addr constant [47 x i8] c"^function[ \09]*\\[.*\\][ \09]*=[ \09]*([a-zA-Z0-9_]+)\00", align 1
@.str.3 = private unnamed_addr constant [3 x i8] c"\\1\00", align 1
@.str.4 = private unnamed_addr constant [11 x i8] c"f,function\00", align 1
@.str.5 = private unnamed_addr constant [54 x i8] c"^function[ \09]*[a-zA-Z0-9_]+[ \09]*=[ \09]*([a-zA-Z0-9_]+)\00", align 1
@.str.6 = private unnamed_addr constant [36 x i8] c"^function[ \09]*([a-zA-Z0-9_]+)[^=]*$\00", align 1
@.str.7 = private unnamed_addr constant [32 x i8] c"^[ \09]*([a-zA-Z0-9_]+)[ \09]*=[ \09]\00", align 1
@.str.8 = private unnamed_addr constant [11 x i8] c"v,variable\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable
define %struct.sParserDefinition* @MatLabParser() #0 {
entry:
  ...
  store %struct.tagRegexTable* getelementptr inbounds ([4 x %struct.tagRegexTable], [4 x %struct.tagRegexTable]* @matlabTagRegexTable, i64 0, i64 0), %struct.tagRegexTable** %tagRegexTable, align 8
