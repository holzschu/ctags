; ModuleID = 'ctags-optlib.c'
source_filename = "ctags-optlib.c"
...
@.str = private unnamed_addr constant [6 x i8] c"ctags\00", align 1
@extensions = internal constant [2 x i8*] [i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i8* null], align 8
@patterns = internal constant [1 x i8*] zeroinitializer, align 8
@aliases = internal constant [1 x i8*] zeroinitializer, align 8
@CtagsKindTable = internal global [2 x %struct.sKindDefinition] [%struct.sKindDefinition { i8 1, i8 108, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i32 0, i32 0), i8 0, i32 0, %struct.sRoleDesc* null, %struct.sScopeSeparator* null, i32 0, i32 0, i32 0, %struct.sKindDefinition* null, %struct.sKindDefinition* null }, %struct.sKindDefinition { i8 1, i8 107, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4, i32 0, i32 0), i8 0, i32 0, %struct.sRoleDesc* null, %struct.sScopeSeparator* null, i32 0, i32 0, i32 0, %struct.sKindDefinition* null, %struct.sKindDefinition* null }], align 8
@CtagsTagRegexTable = internal global [3 x %struct.tagRegexTable] [%struct.tagRegexTable { i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.8, i32 0, i32 0), i8* null, i8 0 }, %struct.tagRegexTable { i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.11, i32 0, i32 0), i8* null, i8 0 }, %struct.tagRegexTable { i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.12, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.11, i32 0, i32 0), i8* null, i8 0 }], align 8
@.str.1 = private unnamed_addr constant [8 x i8] c"langdef\00", align 1
@.str.2 = private unnamed_addr constant [21 x i8] c"language definitions\00", align 1
@.str.3 = private unnamed_addr constant [5 x i8] c"kind\00", align 1
@.str.4 = private unnamed_addr constant [17 x i8] c"kind definitions\00", align 1
@.str.5 = private unnamed_addr constant [21 x i8] c"^--langdef=([^ \09]+)$\00", align 1
@.str.6 = private unnamed_addr constant [3 x i8] c"\\1\00", align 1
@.str.7 = private unnamed_addr constant [2 x i8] c"l\00", align 1
@.str.8 = private unnamed_addr constant [12 x i8] c"{scope=set}\00", align 1
@.str.9 = private unnamed_addr constant [28 x i8] c"^--regex-[^=]+=.*/.,(.+)/.*\00", align 1
@.str.10 = private unnamed_addr constant [2 x i8] c"k\00", align 1
@.str.11 = private unnamed_addr constant [12 x i8] c"{scope=ref}\00", align 1
@.str.12 = private unnamed_addr constant [30 x i8] c"^--kinddef-[^=]+=.,([^,]+),.*\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable
define %struct.sParserDefinition* @CtagsParser() #0 {
entry:
  ...
  store %struct.sKindDefinition* getelementptr inbounds ([2 x %struct.sKindDefinition], [2 x %struct.sKindDefinition]* @CtagsKindTable, i64 0, i64 0), %struct.sKindDefinition** %kindTable, align 8
  ...
  store %struct.tagRegexTable* getelementptr inbounds ([3 x %struct.tagRegexTable], [3 x %struct.tagRegexTable]* @CtagsTagRegexTable, i64 0, i64 0), %struct.tagRegexTable** %tagRegexTable, align 8
  ...
  store void (i32)* @initializeCtagsParser, void (i32)** %initialize, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define internal void @initializeCtagsParser(i32 %language) #0 {
entry:
