...
@.str.11 = private unnamed_addr constant [7 x i8] c"titles\00", align 1
@.str.12 = private unnamed_addr constant [8 x i8] c"section\00", align 1
@.str.13 = private unnamed_addr constant [9 x i8] c"sections\00", align 1
@.str.14 = private unnamed_addr constant [35 x i8] c"^\\.TH[[:space:]]{1,}\22([^\22]{1,})\22.*\00", align 1
@.str.15 = private unnamed_addr constant [3 x i8] c"\\1\00", align 1
@.str.16 = private unnamed_addr constant [2 x i8] c"t\00", align 1
@.str.17 = private unnamed_addr constant [31 x i8] c"{exclusive}{icase}{scope=push}\00", align 1
@.str.18 = private unnamed_addr constant [41 x i8] c"^\\.TH[[:space:]]{1,}([^[:space:]]{1,}).*\00", align 1
@.str.19 = private unnamed_addr constant [35 x i8] c"^\\.SH[[:space:]]{1,}\22([^\22]{1,})\22.*\00", align 1
@.str.20 = private unnamed_addr constant [2 x i8] c"s\00", align 1
@.str.21 = private unnamed_addr constant [30 x i8] c"{exclusive}{icase}{scope=ref}\00", align 1
@.str.22 = private unnamed_addr constant [41 x i8] c"^\\.SH[[:space:]]{1,}([^[:space:]]{1,}).*\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable
define %struct.sParserDefinition* @ManParser() #0 {
entry:
  ...
  store %struct.sKindDefinition* getelementptr inbounds ([2 x %struct.sKindDefinition], [2 x %struct.sKindDefinition]* @ManKindTable, i64 0, i64 0), %struct.sKindDefinition** %kindTable, align 8
  ...
  store %struct.tagRegexTable* getelementptr inbounds ([4 x %struct.tagRegexTable], [4 x %struct.tagRegexTable]* @ManTagRegexTable, i64 0, i64 0), %struct.tagRegexTable** %tagRegexTable, align 8
  ...
  store void (i32)* @initializeManParser, void (i32)** %initialize, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define internal void @initializeManParser(i32 %language) #0 {
entry:
